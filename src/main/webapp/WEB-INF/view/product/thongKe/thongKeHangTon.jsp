...
<div class="row mb-3">
    <div class="col">
        <form action="/thong-ke-ton" method="post" >
    ...
    <div class="col">
        <form action="/thong-ke-thang-ton" method="post" >
...
<c:if test="${type eq 'chart'}">
    <div id="containerton" style="height: 500px"></div>
</c:if>
...
<script>
    $(document).ready(function() {
        ...
        function drawLineChart(productNamesArray,monthNamesArray, quantitiesArray) {
            Highcharts.chart('containerton', {
                chart: {
                    type: 'line',
                    width: 1000
                },
                title: {
                    text: 'Top 10 hang ton'
                },
                xAxis: {
